...
int
DataTransport::send(const uint8_t *msg, uint16_t msg_size, struct sockaddr_in *addr, const socklen_t *addr_size) const {
    return sendto(s, msg, msg_size, 0, (struct sockaddr *) addr, *addr_size);
}

/**********************************************************************************************************************/

int DataTransport::send(const long long unsigned int *msg, uint8_t msg_size, struct sockaddr_in *addr,
